<%@ Page Language="C#" ValidateRequest="true" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="VegiJ.Web.Register" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>VegiJ: Register</title>
    <link href="Content/bootstrap.css" type="text/css" rel="stylesheet" />
    <link href="Content/login-styles.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <form id="registerForm" runat="server" class="form-group form-reg" style="width: 300px">
