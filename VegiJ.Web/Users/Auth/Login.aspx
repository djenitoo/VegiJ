        ...
        <div id="loginForm" class="form-signin">
            <div class="form-container form-group">
                ...
                <div class="input-group">
                    ...
                    <asp:TextBox ID="TxtBoxPassword" CssClass="form-control" placeholder="Password" aria-describedby="psw-gly" runat="server" TextMode="Password" ToolTip="Password should not contain spaces, and should be at leat 6 characters." TabIndex="1"></asp:TextBox>
                ...
                <div class="row">
                    <div class="checkbox">
                        <asp:CheckBox ID="CheckBoxRememberMe" runat="server" TabIndex="3" /><asp:Label ID="LblRememberMe" runat="server" Text="Remember me?" AssociatedControlID="CheckBoxRememberMe"></asp:Label>
                    </div>
                </div>
